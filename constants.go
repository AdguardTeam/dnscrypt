...
const (
	...
	// ErrQueryTooLarge means that the DNS query is larger than max allowed
	// size.
	...
	// ErrServerConfig means that it failed to start the DNSCrypt server -
...
const (
	...
	// See 11. Authenticated encryption and key exchange algorithm.  The public
	// and secret keys are 32 bytes long in storage.
	keySize = 32
